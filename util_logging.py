...
def create_run_md(opt, mode="SupCon"):
    ...
    if mode == "SupCon":
        ...
        lines = [
                    ...
                    "## Training Parameters\n\n",
                    "#### Dataset\n\n",
                    "| dataset | mean | std | size | num classes | aug | resizedCrop | horizontalFlip | colorJitter | grayscale |\n",
                    "|--|--|--|--|--|--|--|--|--|--|\n",
                    f"|{opt.dataset}|{mean}|{std}|{opt.size}|{opt.n_cls}|{opt.aug}|{opt.resizedCrop}|{opt.horizontalFlip}|{opt.colorJitter}|{opt.grayscale}|\n\n",
                    "#### Training\n\n",
